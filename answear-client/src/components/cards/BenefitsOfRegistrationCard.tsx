const BenefitsOfRegistrationCard = () => {
    return (
        <>
            <div className="w-full max-w-xl p-8 space-y-8">
                ...
                <div className="flex items-center mb-4">
                    <div className="bg-orange-200 text-gray-800 w-12 h-12 flex items-center justify-center rounded-full mr-1 flex-shrink-0">
                        1
                    </div>
...
export default BenefitsOfRegistrationCard;
