  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="mt-8 space-y-4 border-2 border-[#dbdce0] p-8">
      ...
      <div>
        ...
        <Select disabled={targetGroupIsLoading} {...register("targetGroupId")} defaultValue="" id="targetGroup">
      ...
      <div>
        ...
        <Select disabled={categoriesIsLoading} {...register("parentId")} defaultValue="" id="parent">
