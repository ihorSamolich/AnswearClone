                    ...
                    <tr key={discount.id} className="bg-white border-b hover:bg-gray-50">
                        ...
                        <td className="px-6 py-4">
                            {isImageFile(discount.mediaFile) ? (
                                <img src={API_URL + `/images/800_${discount.mediaFile}`} alt={discount.name} className="h-20 w-20 object-cover" />
                        ...
                        <td className="px-6 py-4 text-right space-x-5">
                            <Button onClick={() => navigate(`/admin/discounts/edit/${discount.id}`)} variant="icon" size="iconmd">
